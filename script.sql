...
BEGIN
	...
	VALUES
		(prodName, price, size, typeId, avgTime, imageUrl, product_stock);
...
DELIMITER //
CREATE PROCEDURE Tejuana.UpdateProduct (prodId INT, prodName VARCHAR(100), price NUMERIC(15,2), size VARCHAR(10), typeId INT, avgTime INT, imageUrl VARCHAR(255), stock INT)
BEGIN
	UPDATE 
		Tejuana.Product
	SET
...
INSERT INTO Tejuana.Product VALUES (3, 'Top Mery Rosa', 200, 'S', 2, 7, 100, 'https://scontent-gru2-1.xx.fbcdn.net/v/t1.0-0/p480x480/15219369_1352039674815664_2465993764460513865_n.jpg?oh=416acbb69780bd6cd6136b26bf6c0ee3&oe=58BDB101');
INSERT INTO Tejuana.Product VALUES (4, 'Top Mery Crudo', 220, 'M', 2, 8, 100, 'https://fb-s-c-a.akamaihd.net/h-ak-xpt1/v/t1.0-9/15094480_1343335192352779_4701827482473836564_n.jpg?oh=bb52701e6900cc4555ca72bc96d6ee24&oe=58BA51D4&__gda__=1488906051_5454fcbb81a6f36764bdc17204ab98b6');
